 ...
 * 16 카테고리 × 15~18개 = 240+ 별
 * 매칭·검색·콘텐츠 피드 모두 이 카탈로그 기반.
 */
...
export const STARS: StarDoc[] = [
  ...
  s("kindie", "k_indie", "K-인디씬", "한국 인디 음악의 작은 우주", 1, "country", "KR", "대한민국"),
  s("hongdaeindie", "hongdae_indie", "홍대 인디씬", "홍대 거리의 라이브 클럽 문화", 1, "neighborhood", "KR/Seoul/홍대", "홍대"),
  s("kpop", "kpop", "K-팝", "한국에서 세계로", 1, "country", "KR", "대한민국"),
  s("trot", "trot", "트로트", "한국 가요의 기둥", 1, "country", "KR", "대한민국"),
  ...
  s("koreanpainting", "korean_painting", "한국화", "여백의 미", 2, "country", "KR", "대한민국"),
  ...
  s("matgyup", "knot_craft", "매듭공예", "한 가닥 실로 그려내는 정중한 무늬", 3, "country", "KR", "대한민국"),
  s("seongsushoes", "seongsu_handmade_shoes", "성수동 수제화", "성수동 골목의 가죽 냄새와 미싱 소리", 3, "neighborhood", "KR/Seoul/성수동", "성수동"),
  s("eulpapers", "eulji_print", "을지로 인쇄소", "잉크 냄새가 배어든 을지로의 골목", 3, "neighborhood", "KR/Seoul/을지로", "을지로"),
  ...
  s("hanji", "hanji", "한지공예", "닥나무로 만든 한국 종이", 3, "country", "KR", "대한민국"),
  s("origami", "origami", "종이접기", "한 장의 종이가 형태로", 3),
  s("najeon", "najeon", "자개공예", "조개껍질의 무지개", 3, "country", "KR", "대한민국"),
  ...
  s("samulnori", "samulnori", "사물놀이", "꽹과리·징·장구·북의 합주", 4, "country", "KR", "대한민국"),
  ...
  // ─────── 5. 운동 ───────
  s("hangang", "hangang_bike", "한강 자전거", "한강을 따라 흐르는 바람과 바퀴", 5, "city", "KR/Seoul", "서울"),
  ...
  s("noporo", "old_eatery", "노포", "오래된 가게의 시간이 빚은 맛", 6, "country", "KR", "대한민국"),
  ...
  s("hansik", "hansik", "한식", "밥과 국과 반찬", 6, "country", "KR", "대한민국"),
  s("kimchi", "kimchi", "김치", "발효의 한국식 미학", 6, "country", "KR", "대한민국"),
  s("tteok", "tteok", "떡", "쌀로 만드는 다양한 모양", 6, "country", "KR", "대한민국"),
  ...
  s("sijo", "sijo", "시조", "3장 6구의 한국 정형시", 7, "country", "KR", "대한민국"),
  ...
  s("koreanlit", "korean_lit", "한국문학", "이상부터 김초엽까지", 7, "country", "KR", "대한민국"),
  ...
  s("baduk", "baduk", "바둑", "흑백의 우주", 8, "country", "KR", "대한민국"),
  s("janggi", "janggi", "장기", "한국식 체스", 8, "country", "KR", "대한민국"),
  ...
  s("koreanfilm", "korean_film", "한국영화", "봉준호부터 박찬욱까지", 10, "country", "KR", "대한민국"),
  ...
  // ─────── 13. 전통 ───────
  s("janggu", "janggu", "장구", "한국 전통 타악기의 양면 가락", 13, "country", "KR", "대한민국"),
  s("teaceremony", "tea_ceremony", "전통차", "차 한 잔에 담긴 느림의 시간", 13, "country", "KR", "대한민국"),
  s("hanbok", "hanbok", "한복", "한국의 옷", 13, "country", "KR", "대한민국"),
  s("hanok", "hanok", "한옥", "한국의 집", 13, "country", "KR", "대한민국"),
  s("folkgames", "folk_games", "전통놀이", "윷놀이·연날리기·널뛰기", 13, "country", "KR", "대한민국"),
  s("pungmul", "pungmul", "풍물", "마을의 흥", 13, "country", "KR", "대한민국"),
  s("templefood", "temple_food", "사찰음식", "절에서 만드는 정갈한 음식", 13, "country", "KR", "대한민국"),
  s("dado", "dado", "다도", "차를 따르는 의식", 13, "country", "KR", "대한민국"),
  s("traditionalwedding", "traditional_wedding", "전통혼례", "한복 입고 절하는 결혼식", 13, "country", "KR", "대한민국"),
  s("gut", "gut", "굿", "무당의 의식", 13, "country", "KR", "대한민국"),
  s("fortune", "fortune_telling", "사주", "태어난 시간의 운명", 13, "country", "KR", "대한민국"),
  s("fengshui", "fengshui", "풍수", "땅의 기운을 읽는 일", 13),
  s("hanyak", "hanyak", "한약", "달이는 약", 13, "country", "KR", "대한민국"),
  s("acupuncture", "acupuncture", "침술", "혈자리에 놓는 침", 13, "country", "KR", "대한민국"),
  s("folktales", "folktales", "전래동화", "할머니가 들려주던 이야기", 13, "country", "KR", "대한민국"),
  ...
  s("kbeauty", "kbeauty", "K-뷰티", "10단계 스킨케어의 나라", 15, "country", "KR", "대한민국"),
  ...
  // 영통 / 경희대 국제캠퍼스 (시연용 — 발표 장소)
  s("kyunghee_campus", "kyunghee_intl_campus", "경희대 국제캠퍼스", "수원 영통의 넓은 산책로와 호수", 9, "neighborhood", "KR/Suwon/영통", "영통"),
  s("hoegidong_noporo", "yeongtong_old_eatery", "영통 노포", "학생들이 자취하며 드나드는 오래된 가게", 6, "neighborhood", "KR/Suwon/영통", "영통"),
  s("hoegidong_alleys", "yeongtong_alleys", "영통 골목", "캠퍼스 너머의 자취 거리", 16, "neighborhood", "KR/Suwon/영통", "영통"),
  s("kyunghee_pungmul", "kyunghee_pungmul", "경희대 풍물패", "캠퍼스에 울리는 꽹과리·장구 가락", 13, "neighborhood", "KR/Suwon/영통", "영통"),
  s("hoegi_cafe_st", "yeongtong_cafe_street", "영통 카페 거리", "스터디카페부터 작은 로스터리까지", 16, "neighborhood", "KR/Suwon/영통", "영통"),
  s("kyunghee_festival", "kyunghee_festival", "경희대 축제", "5월의 가요제와 동아리 무대", 4, "neighborhood", "KR/Suwon/영통", "영통"),
  s("kyunghee_film", "kyunghee_film", "경희대 영화학과", "캠퍼스에서 만들어지는 단편영화", 10, "neighborhood", "KR/Suwon/영통", "영통"),
  s("kyunghee_orchestra", "kyunghee_orchestra", "경희 오케스트라", "필하모닉의 정기 연주회", 1, "neighborhood", "KR/Suwon/영통", "영통"),
];

// ─────── 콘텐츠 (별마다 큐레이션 카드뉴스 일부) ───────
// MVP에선 YouTube 피드가 메인이라 콘텐츠는 일부 별만 채움.
const c = (
  id: string,
  starId: string,
...
export const CONTENTS: ContentDoc[] = [
  ...
  c("jazz_2", "jazz", "cardnews", "재즈의 즉흥", "악보 없이 호흡으로 대화하는 음악.", G.amber, 2),
